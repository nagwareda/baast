...
public class SerialListFragment extends BaseFragment implements SerialListResponseListener, View.OnClickListener,
    ...
    private void intiViews() {
        ...
        title.setText(getActivity().getString(R.string.serial));
        setAdapters();
        initDataList();
    }
